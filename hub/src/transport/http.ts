...
import { mountP2Surface } from '../ui/p2-surface-mount.js';
import { registerHtmlSourceTool } from '../ui/html-source-mcp.js';
...
export function mountStreamableHttpHub(
  ...
  mountP2Surface(app, { hubDb: deps.hubDb, mirrorRoot: deps.mirrorRoot });
