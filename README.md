...
> 截图位于 `screenshots/`，均为本地 Hub 实拍。

| Agent 控制 | Start Agent |
|:---:|:---:|
| ![Agent Control — Prompt 下发与 Pending 任务](screenshots/pc-01-hub-agent-control.png) | ![Start Agent — PolarClaw / 模型选择](screenshots/pc-02-start-agent.png) |
